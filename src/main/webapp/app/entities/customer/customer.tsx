            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('registerDate')}>
                  Register Date <FontAwesomeIcon icon={getSortIconByFieldName('registerDate')} />
                </th>
                <th className="hand" onClick={sort('customerType')}>
                  Customer Type <FontAwesomeIcon icon={getSortIconByFieldName('customerType')} />
                </th>
                ...
                <th className="hand" onClick={sort('primaryEmail')}>
                  Primary Email <FontAwesomeIcon icon={getSortIconByFieldName('primaryEmail')} />
                </th>
                <th className="hand" onClick={sort('primaryPhone')}>
                  Primary Phone <FontAwesomeIcon icon={getSortIconByFieldName('primaryPhone')} />
                </th>
            ...
            <tbody>
              {customerList.map((customer, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {customer.registerDate ? <TextFormat type="date" value={customer.registerDate} format={APP_LOCAL_DATE_FORMAT} /> : null}
                  </td>

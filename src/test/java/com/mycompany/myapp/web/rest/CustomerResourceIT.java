...
class CustomerResourceIT {
    ...
    private static final CustomerType DEFAULT_CUSTOMER_TYPE = CustomerType.PERSONAL;
    ...
    private static final CustomerStatus UPDATED_STATUS = CustomerStatus.IN_ACTIVE;
    ...
    void partialUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.primaryEmail(UPDATED_PRIMARY_EMAIL).primaryPhone(UPDATED_PRIMARY_PHONE);
